...
const ageOptions = {
    ...
    plugins: {
        ...
        title: {display: true, text: 'Distribusi Penduduk Berdasarkan Usia'}
    },
    scales: {
        x: {
...
if (populationTrendCtx) {
    new Chart(populationTrendCtx, {
        ...
        options: {
            ...
            plugins: {
                legend: { display: true, position: 'top' },
                title: { display: true, text: 'Tren Jumlah Penduduk (2020-2024)' }
            },
            scales: {
                x: {
...
if (maritalStatusCtx) {
    new Chart(maritalStatusCtx, {
        ...
        options: {
            ...
            plugins: {
                legend: { display: true, position: 'top' },
                title: { display: true, text: 'Distribusi Status Kawin' }
            }
        }
    });
}
...
const jobOptions = {
    ...
    plugins: {
        legend: { display: true, position: 'top' },
        title: { display: true, text: 'Distribusi Pekerjaan Penduduk' }
    },
    scales: {
        x: {
